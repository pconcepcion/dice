...
func TestParse(t *testing.T) {
	var parseTestStrings = []struct {
		...
		{"4d8r2", SimpleDiceExpression{numDices: 4, expressionText: "4d8r2", sides: 8, reroll: 2}},
		...
		{"8d6o", SimpleDiceExpression{numDices: 8, expressionText: "8d6o", sides: 6, open: 6}},
		{"10d10o", SimpleDiceExpression{numDices: 10, expressionText: "10d10o", sides: 10, open: 10}},
		// More complex expressions (omiting the number of dices -> 1 dice)
		{"d6o", SimpleDiceExpression{numDices: 1, expressionText: "d6o", sides: 6, open: 6}},
...
func TestRoll(t *testing.T) {
	var parseTestStrings = []struct {
		...
		{"3d6k2", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 3, expressionText: "3d6k2", sides: 6, keep: 2}}},
		{"4d8r2", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 4, expressionText: "4d8r2", sides: 8, reroll: 2}}},
		{"6d6e", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 6, expressionText: "6d6e", sides: 6, explodeResult: 6}}},
		{"7d6es8", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 7, expressionText: "7d6es8", sides: 6, explodeResult: 6, target: 8}}},
		{"8d6o", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 8, expressionText: "8d6o", sides: 6, open: 6}}},
		{"10d10o", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 10, expressionText: "10d10o", sides: 10, open: 10}}},
		// More complex expressions (omiting the number of dices -> 1 dice)
		{"d6o", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 1, expressionText: "d6o", sides: 6, open: 6}}},
		{"d6e", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 1, expressionText: "d6e", sides: 6, explodeResult: 6}}},
		{"d6es4", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 1, expressionText: "d6es4", sides: 6, explodeResult: 6, target: 4}}},
		{"d100es96", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 1, expressionText: "d100es96", sides: 100, explodeResult: 100, target: 96}}},
		{"d100k1", simpleDiceExpressionResult{diceExpression: SimpleDiceExpression{numDices: 1, expressionText: "d100k1", sides: 100, keep: 1}}},
		/*{"d6o", []Token{{tokenDice, "d"}, {tokenNumber, "6"}, {tokenModifier, "o"}, {tokenEOF, ""}}},
		{"d6e", []Token{{tokenDice, "d"}, {tokenNumber, "6"}, {tokenModifier, "e"}, {tokenEOF, ""}}},
		{"d6es4", []Token{{tokenDice, "d"}, {tokenNumber, "6"}, {tokenModifier, "es"}, {tokenNumber, "4"}, {tokenEOF, ""}}},
		{"d100es96", []Token{{tokenDice, "d"}, {tokenNumber, "100"}, {tokenModifier, "es"}, {tokenNumber, "96"}, {tokenEOF, ""}}},
